...
function cantidadJugadoresPartida(numJugadores) {
  ...
  var btnJugadoresPartida =
    document.getElementsByClassName("btn_CantJugadores");
  // reseteo de botones
  ...
  document.getElementById(`seleccionCantJugadores${cantidadJugadores}`).style =
    "color:#244C76;background-color:white ;";
...
function seleccionAvatar(idSelect) {
  ...
  var numAvatar =
    avataresSeleccionados.numeroAvatarSeleccionado[playerSeleccion];
  ...
  var imprimirAvatarElegido = document.getElementById(
    `seleccionAvatar${idSelect}`
  );
