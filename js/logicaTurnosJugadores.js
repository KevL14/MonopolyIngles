...
async function actualizarTurno() {
  ...
  if (cantidadJugadores > 1) {
    if (positionPlayers.penalidades[siguienteJugador] > 0 || ordenGanadores.indexOf(siguienteJugador)!=-1) {
      while (positionPlayers.penalidades[siguienteJugador] > 0 || ordenGanadores.indexOf(siguienteJugador)!=-1) {
